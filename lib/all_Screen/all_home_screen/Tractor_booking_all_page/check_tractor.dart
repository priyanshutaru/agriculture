...
class CheckTractor extends StatefulWidget {
  CheckTractor({Key? key, this.name, this.number}) : super(key: key);
  String? name, number;
...
class _CheckTractorState extends State<CheckTractor> {
  Future updateTractorYes() async {
    final pref = await SharedPreferences.getInstance();
    var user_id = pref.getString('user_id');
    Map data = {'user_id': user_id.toString(), 'tractor_status': '0'};
    var data1 = jsonEncode(data);
    var url = Uri.parse(
        "https://doplus.creditmywallet.in.net/api/update_tractor_status");
  ...
  Future updateTractorNo() async {
    final pref = await SharedPreferences.getInstance();
    var user_id = pref.getString('user_id');
    Map data = {'user_id': user_id.toString(), 'tractor_status': '1'};
    var data1 = jsonEncode(data);
    var url = Uri.parse(
        "https://doplus.creditmywallet.in.net/api/update_tractor_status");
    final response = await http.post(url,
