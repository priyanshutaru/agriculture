class customer_bill_list {
  int? statusCode;
  String? statusMessage;
  List<Data>? response;

  customer_bill_list({this.statusCode, this.statusMessage, this.response});

  customer_bill_list.fromJson(Map<String, dynamic> json) {
    statusCode = json['status_code'];
    statusMessage = json['status_message'];
    if (json['response'] != null) {
      response = <Data>[];
      json['response'].forEach((v) {
        response!.add(new Data.fromJson(v));
      });
    }
  }
