...
import 'package:agriculture/all_Screen/all_home_screen/Tractor_booking_all_page/search_model.dart';
...
class Fill_Customer_Details extends StatefulWidget {
  const Fill_Customer_Details({Key? key}) : super(key: key);
  @override
  State<Fill_Customer_Details> createState() => _Fill_Customer_DetailsState();
}

class _Fill_Customer_DetailsState extends State<Fill_Customer_Details> {
  ...
  Future Add_New_Customer() async {
    ...
    var url = Uri.parse(
        "https://doplus.creditmywallet.in.net/api/add_tractor_customer");
