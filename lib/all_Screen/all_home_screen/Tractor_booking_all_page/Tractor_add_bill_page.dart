...
class Tractor_bill_page extends StatefulWidget {
  const Tractor_bill_page({Key? key}) : super(key: key);
  @override
  State<Tractor_bill_page> createState() => _Tractor_bill_pageState();
}

class _Tractor_bill_pageState extends State<Tractor_bill_page> {
  int _currentIndex = 0;
  ...
  Future tractor_AddBill() async {
    ...
    var response = await dio.post(
        'https://doplus.creditmywallet.in.net/api/add_tractor_bill',
        data: formData);
    ...
    if (msg == 200) {
      ...
      setState(() {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => Tractor_page()));
        _name.clear();
        _number.clear();
        _unit.clear();
        _totalHours.clear();
